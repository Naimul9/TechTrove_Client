...
const Footer = () => {
    return (
      <footer className="px-4 divide-y bg-gray-800 dark:bg-gray-100 text-black ">
        ...
        <div className="lg:w-1/3" >
          <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
            <div className="flex items-center justify-center w-12 h-12 rounded-full bg-violet-400 dark:bg-violet-600" >
             <img src="https://i.ibb.co.com/nsdjk9N/android-chrome-512x512.png" alt="" />
            </div>
            <span className="self-center text-xl italic uppercase font-bold">TechTrove</span>
          </a>
        </div>
      ...
      <div className="py-6 text-sm text-center  font-semibold" >© 2024 Tech Trove | | All rights reserved.</div>
    </footer>
    );
};
